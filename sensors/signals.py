...
def compute_metrics(sender, instance: PressureFrame, **kwargs):
    if instance.frame:
        instance.contact_area_pct = contact_area_pct(instance.frame, lower_threshold=200)
        instance.peak_pressure_index = peak_pressure_index(instance.frame, min_region_pixels=10, lower_threshold=200)
        hp = high_pressure(instance.frame, high_threshold=2000, hotspot_pixels=10)
